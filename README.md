# JSON to TypeScript — Generate Types & Interfaces Online

> Generate clean TypeScript interfaces and types from JSON payloads instantly. Handles nested structures, optional fields, and type inference offline.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/json-to-typescript/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/json-to-typescript/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/json-to-typescript/](https://cig13zs.github.io/json-to-typescript/) or install the offline Chrome Extension package.
...
Paste your JSON sample data. The tool infers strict TypeScript interface definitions and recursive sub-types ready to copy into your codebase.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/json-to-typescript.git
   ```
